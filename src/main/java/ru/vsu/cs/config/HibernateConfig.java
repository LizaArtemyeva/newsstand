...
public class HibernateConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl(environment.getRequiredProperty("database.connection_url"));
        dataSource.setUsername(environment.getRequiredProperty("database.user"));
        dataSource.setPassword(environment.getRequiredProperty("database.pass"));
        return dataSource;
    }
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("ru.vsu.cs.Domain");
